...
function dale(playerNumber, character){
...
dale.prototype.loadPlayer = function(GameState){
    GameState.game.load.image('dale', '/assets/gfx/dale_gribble.png');
}
    
dale.prototype.enablePlayer = function(GameState){
    //Load Player sprite
    this.sprite = GameState.game.add.sprite(GameState.game.width / 2, GameState.game.height-20, 'dale');
...
dale.prototype.movePlayer = function(GameState){
...
dale.prototype.jumpPlayer = function(GameState){
